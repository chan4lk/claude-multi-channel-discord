...
function AlertsPageInner() {
  ...
  useEffect(() => { void fetchAlerts(typeFilter, slugFilter) }, [typeFilter, slugFilter, fetchAlerts])
    ...
    <div className="min-h-dvh bg-[#050b14] text-slate-200 p-4 sm:p-6">
      ...
      <div className="overflow-x-auto rounded-xl border border-slate-800">
        <table className="w-full text-xs font-mono border-collapse">
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={4} className="text-center py-12 text-slate-600">Loading…</td>
              </tr>
            ) : alerts.length === 0 ? (
              <tr>
      ...
      {nextCursor != null && (
        <div className="mt-4 text-center">
          <button
            onClick={() => void fetchAlerts(typeFilter, slugFilter, nextCursor, true)}
